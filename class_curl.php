...
class curl {
    ...
    public function __construct($options = array()) {
        ...
        $this->initialize_default_options($options);
     ...
     */
    private function initialize_default_options($options = array()) {
        $this->options = array();
        
        $this->options['CURLOPT_USERAGENT']         = isset($options['CURLOPT_USERAGENT'])? (string) $options['CURLOPT_USERAGENT'] : 'cURL';
        // True to include the header in the output
        $this->options['CURLOPT_HEADER']            = isset($options['CURLOPT_HEADER'])? (bool) $options['CURLOPT_HEADER'] : 0;
        // True to Exclude the body from the output
        $this->options['CURLOPT_NOBODY']            = isset($options['CURLOPT_NOBODY'])? (bool) $options['CURLOPT_NOBODY'] : 0;
        ...
        $this->options['CURLOPT_MAXREDIRS']         = isset($options['CURLOPT_MAXREDIRS'])? intval($options['CURLOPT_MAXREDIRS']) : 10;
        $this->options['CURLOPT_ENCODING']          = '';
        // TRUE to return the transfer as a string of the return
        // value of curl_exec() instead of outputting it out directly.
        $this->options['CURLOPT_RETURNTRANSFER']    = isset($options['CURLOPT_RETURNTRANSFER'])? (bool) $options['CURLOPT_RETURNTRANSFER'] : 1;
        $this->options['CURLOPT_BINARYTRANSFER']    = isset($options['CURLOPT_BINARYTRANSFER'])? (bool) $options['CURLOPT_BINARYTRANSFER'] : 0;
        $this->options['CURLOPT_SSL_VERIFYPEER']    = isset($options['CURLOPT_SSL_VERIFYPEER'])? (bool) $options['CURLOPT_SSL_VERIFYPEER'] : 0;
        $this->options['CURLOPT_SSL_VERIFYHOST']    = isset($options['CURLOPT_SSL_VERIFYHOST'])? intval($options['CURLOPT_SSL_VERIFYHOST']) : 2;
        $this->options['CURLOPT_CONNECTTIMEOUT']    = isset($options['CURLOPT_CONNECTTIMEOUT'])? intval($options['CURLOPT_CONNECTTIMEOUT']) : 30;
